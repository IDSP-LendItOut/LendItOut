        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              newContent =
                (_a = doc.getElementById("content")) === null || _a === void 0
                  ? void 0
                  : _a.innerHTML;
              ...
              if (seeAllLink) {
                seeAllLink.href =
                  tab === "buying" ? "/buying-page" : "/renting-page";
              }
              return [2 /*return*/];
          }
        });
  ...
  buttonContainer === null || buttonContainer === void 0
    ...
    : buttonContainer.addEventListener("click", function (e) {
        ...
        if (button) {
          ...
          if (route) {
            window.location.href = "profile".concat(route);
